 ...
 */
public class TestIaaPlugin extends GATEPluginTestCase {
  ...
  public void testIaaPlugin() throws Exception {
    ...
    try {
      ...
      Document doc = Factory.newDocument(this.getClass().getResource("/tests/iaa/beijing-opera.xml"), "UTF-8");
      Document doc1 = Factory.newDocument(this.getClass().getResource("/tests/iaa/beijing-opera-2.xml"), "UTF-8");
  ...
  public void testIaaBDM() throws Exception {
    ...
    try {
      ...
      //System.out.println("testDir00=*"+(new File(testDir,"beijing-opera.xml")).getAbsolutePath().toString()+"*");
      Document doc = Factory.newDocument(this.getClass().getResource("/tests/iaa/ontoData/ft-airlines-27-jul-2001.xml"), "UTF-8");
      Document doc1 = Factory.newDocument(this.getClass().getResource("/tests/iaa/ontoData/ft-airtours-08-aug-2001.xml"), "UTF-8");
      data.add(doc);
      data.add(doc1);
      ...
      iaaM.setVerbosity("0");
      iaaM.setBdmScoreFile(this.getClass().getResource("/tests/iaa/ontoData/protonU-bdm.txt"));
